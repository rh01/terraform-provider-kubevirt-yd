...
import (
	...
	"github.com/rh01/terraform-provider-kubevirt-yd/kubevirt/schema/datavolume"
	"github.com/rh01/terraform-provider-kubevirt-yd/kubevirt/schema/virtualmachineinstance"
